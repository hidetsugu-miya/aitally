...
RSpec.describe ClaudeCollector::Parser do
  ...
  describe "#parse" do
    context "with valid JSON fixture" do
      ...
      it "extracts all session fields" do
      ...
      it "parses model_usages for each session" do
    ...
    context "with invalid JSON" do
      it "retries and returns empty array after max retries" do
        ...
        expect(parser).to have_received(:sleep).exactly(3).times
      end
    end
